...
CREATE TABLE IF NOT EXISTS ai_config (
  ...
  primary_key_encrypted TEXT,       -- Key unica de OpenRouter
  fallback_key_encrypted TEXT,      -- Legacy sin uso
  features JSONB NOT NULL DEFAULT '{
    "product_vision":   { "enabled": true, "model": "openai/gpt-4o-mini" },
    "chat_summary":     { "enabled": true, "model": "openai/gpt-4o-mini" },
    "notif_parser":     { "enabled": true, "model": "openai/gpt-4o-mini" }
  }'::jsonb,
...
CREATE TABLE IF NOT EXISTS ai_usage_log (
  ...
  model TEXT NOT NULL DEFAULT 'openrouter:openai/gpt-4o-mini',
