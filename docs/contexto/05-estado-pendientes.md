...
| 2026-05-16 | fix: portero MacroDroid acepta pagos cuyo captured_at_ms cae dentro de la ventana de sesión aunque el Live ya esté cerrado (fix retraso Android) | pendiente push |
